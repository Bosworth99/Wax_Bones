...
<section id="respond" class="respond-form">
	...
	<form id="commentform" class="big-form" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" >

		<fieldset id="comment-form-elements">
	...
	<?php else : ?>
			...
			<div class="control-group clearfix">
				<label class="control-label	col_fourth" for="author"><?php _e( 'Name', 'bonestheme' ); ?> <?php if ($req) _e( '*'); ?></label>
				<div class="controls col_threefourth">
					<input id="author" class="input-name input input-full" name="author" type="text" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e( 'Your Name*', 'bonestheme' ); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
				</div>
			</div>

			<div class="control-group clearfix">
				<label class="control-label	col_fourth" for="email"><?php _e( 'Mail', 'bonestheme' ); ?> <?php if ($req) _e( '*'); ?></label>
				<div class="controls col_threefourth">
					<input id="email" class="input-name input input-full" name="email" type="text" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e( 'Your Email*', 'bonestheme' ); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /><br/>
					<!--<small><?php _e("(will not be published)", 'bonestheme' ); ?></small>-->
				</div>
			</div>

			<div class="control-group clearfix">
				<label class="control-label	col_fourth" for="url"><?php _e( 'Website', 'bonestheme' ); ?></label>
				<div class="controls col_threefourth">
					<input id="url" class="input-name input input-full" name="url" type="url" value="<?php echo esc_attr($comment_author_url); ?>" placeholder="<?php _e( 'Got a website?', 'bonestheme' ); ?>" tabindex="3" />
				</div>
			</div>			
		...
		<li>
			<label for="email"><?php _e( 'Mail', 'bonestheme' ); ?> <?php if ($req) _e( '*'); ?></label>
	...
	<?php endif; ?>
			...
			<div class="control-group clearfix">
				<textarea id="comment" class="input-name input input-full" name="comment" placeholder="<?php _e( 'Your Comment here...', 'bonestheme' ); ?>" tabindex="4"></textarea>
			</div>	

			<div class="control-group">
				<div class="actions clearfix">
					<input id="submit" class="button large align-right" name="submit" type="submit"  tabindex="5" value="<?php _e( 'Submit', 'bonestheme' ); ?>" />
				</div>
			</div>	
